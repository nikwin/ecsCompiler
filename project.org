...
** TODO Make a shortcut for the xComponent: ~() + --- ~xComponent. Make it something like ~~~ in the file to do both
** TODO Be able to make ad-hoc subclassese through csvs alone
